                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                            @if(isset($m->subMenu))
                                <a href="#"> <i class="{{$m->icon}}"></i>{{ $m->title }}</a>
                                <ul class="submenu">
                                @foreach($m->subMenu as $menuItem)
                                    <li class="has-submenu">
                                        @if(isset($menuItem->subMenu))
                                        <a href="#">{{ $menuItem->title }}</a>
                                        <ul class="submenu">
                                            @foreach($menuItem->subMenu as $sm2)
                                            <li><a href="{{$sm2->url}}">{{ $sm2->title }}</a></li>
                                            @endforeach
                                        </ul>
                                    <li>
                                    @else
                            ...
                            @else
                            <a href="{{$m->url}}"> <i class="{{$m->icon}}"></i>{{ $m->title }}</a>
                            @endif
                        </li>
                        @endforeach
