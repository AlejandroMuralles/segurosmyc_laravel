    ...
    <div class="col-lg-12">
        <div class="card-box">
			...
			@endif
				...
				<div class="col-lg-4">{!! Field::text('fecha_nacimiento', null, ['data-required'=>'false','class'=>'fecha']) !!}</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-4">{!! Field::select('departamento_facturacion_id', $departamentos, null, ['id'=>'departamento_facturacion_id', 'data-required'=>'true']) !!}</div>
				<div class="col-lg-4">{!! Field::select('municipio_facturacion_id', $municipios, null, ['id'=>'municipio_facturacion_id', 'data-required'=>'true']) !!}</div>
				<div class="col-lg-12">
			...
			<div class="row">
				...
				<div class="col-lg-4">{!! Field::select('departamento_fiscal_id', $departamentos, null, ['id'=>'departamento_fiscal_id', 'data-required'=>'true']) !!}</div>
				<div class="col-lg-4">{!! Field::select('municipio_fiscal_id', $municipios, null, ['id'=>'municipio_fiscal_id', 'data-required'=>'true']) !!}</div>
				<div class="col-lg-12">
