...
@section('title') Editar Vehículo de Póliza @stop

@section('header') Editar Vehículo de Póliza @stop
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            {!! Form::model($vehiculo,['route' => array('editar_poliza_vehiculo',$vehiculo->id), 'method' => 'PUT', 'id' => 'form', 'class' => 'validate-form']) !!}

				
				<div class="row">
					<div class="col-lg-6">
						{!! Field::text('placa', $vehiculo->vehiculo->placa, ['data-required'=>'true', 'disabled']) !!}
					</div>
					<div class="col-lg-6">
	            ...
	            <p>
	                ...
	                @if($vehiculo->poliza->estado == 'P')
	                	<a href="{{ route('ver_solicitud_poliza',$vehiculo->poliza_id) }}#vehiculos" class="btn btn-danger">Cancelar</a>
	                @else
	                	<a href="{{ route($vehiculo->poliza->ruta,$vehiculo->poliza_id) }}#vehiculos" class="btn btn-danger">Cancelar</a>
	                @endif
	            </p>
