        ...
        <div class="card-box">
            {!! Form::model($colaborador, ['route' => array('editar_colaborador',$colaborador->id), 'files'=>true, 'method' => 'PUT', 'id' => 'form', 'class'=>'validate-form']) !!}
				...
				<div class="form-group">
					...
					<input type="radio" name="sexo" value="0" @if($colaborador->sexo == 0) checked @endif> Femenino</input>&nbsp;&nbsp;&nbsp;
					<input type="radio" name="sexo" value="1" @if($colaborador->sexo == 1) checked @endif> Masculino</input>
				</div>
