...
@section('title') Agregar Cobertura General a Inclusión {{$polizaInclusion->numero_solicitud}} @stop

@section('header') Agregar Cobertura General a Inclusión {{$polizaInclusion->numero_solicitud}} @stop

@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            {!! Form::open(['route' => array('agregar_poliza_inclusion_cobertura',$polizaInclusion->id), 'method' => 'POST', 'id' => 'form', 'class' => 'validate-form']) !!}
