...
@section('title') Agregar Vehículo a Inclusión {{$polizaInclusion->numero_solicitud}} @stop

@section('header') Agregar Vehículo a Inclusión {{$polizaInclusion->numero_solicitud}} @stop
@section('css')
