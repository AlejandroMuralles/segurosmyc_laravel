...
@section('title') Editar Vehiculo @stop

@section('header') Editar Vehiculo @stop

@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            {!! Form::model($vehiculo, ['route' => array('editar_vehiculo', $vehiculo->id), 'method' => 'PUT', 'id' => 'form', 'class' => 'validate-form']) !!}
