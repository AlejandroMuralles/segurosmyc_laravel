        ...
        <ul class="nav nav-tabs navtab-custom">
            ...
            <li class="">
                <a href="#coberturas_particulares" data-toggle="tab" aria-expanded="true">
                    <span class="visible-xs"><i class="fa fa-list"></i></span>
                    <span class="hidden-xs">Cob. Particulares</span>
                </a>
            </li>
            <li class="">
									...
									<tbody>
										...
										@foreach($vehiculos as $index => $vehiculo)
											...
											<tr>
												...
												<td class="text-right">Q. {{ number_format($vehiculo->fraccionamiento,2) }}</td>
												...
												<td class="text-center">{{ $vehiculo->numero_inclusion }} </td>
												<td class="text-center">{{ $vehiculo->numero_exclusion }} </td>
												<td>
													...
													<a href="{{route('agregar_poliza_vehiculo_reclamo',$vehiculo->id)}}" class="btn btn-inverse btn-xs fa fa-plus" data-toggle="tooltip" data-placement="top" title="" data-original-title="Agregar Reclamo"></a>
													@endif
												</td>
											</tr>
										@endforeach
												...
												<td>
													...
													@if($poliza->estado == 'V')
														@if($in->estado == 'S')
															...
															<a href="{{route('agregar_poliza_inclusion_cobertura_vehiculo',[$in->id,0])}}" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" data-original-title="Agregar Cobertura Particular"><i class="fa fa-plus"></i><i class="fa fa-car"></i><i class="fa fa-list"></i></a>
