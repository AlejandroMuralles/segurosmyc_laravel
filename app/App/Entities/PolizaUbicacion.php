...
class PolizaUbicacion extends \Eloquent {

	protected $fillable = ['poliza_id','numero_certificado','suma_asegurada','prima_neta','iva','prima_total','pct_iva','pct_fraccionamiento','pct_emision','estado','fecha_inclusion','poliza_inclusion_id','poliza_exclusion_id','pct_deducible_robo','deducible_minimo_robo','pct_deducible_dano','deducible_minimo_dano','motivo_anulacion_id','fecha_anulacion','activo_declaracion','cliente_id','asistencia'];

	protected $table = 'poliza_ubicacion';
